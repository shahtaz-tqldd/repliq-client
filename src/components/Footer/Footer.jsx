...
const Footer = () => {
  ...
  return (
    <footer className="mt-16 max-w-7xl mx-auto">
      <section className="grid lg:grid-cols-4 grid-cols-2 mb-4 pt-12">
        <div>
          <h2 className='text-2xl font-bold'>Repliq Shop</h2>
          <h2 className='uppercase mt-3 text-xs lg:tracking-[4px] tracking-[1px]'>A modern Online Store</h2>
        </div>
        <div>
        ...
        <div className='text-sm'>
          ...
          <span className='flex items-center gap-2 mb-[5px]'><HiOutlineMail /> shop@repliq.com</span>
          <span className='flex items-center gap-2 mb-[5px]'><HiOutlinePhone /> +99012345 </span>
        </div>
      </section>
      <hr />
      <section className="py-5 flex justify-between">
        <div className='lg:text-md md:text-sm text-xs'>All rights reserved to Repliq Shop &copy; {new Date().getFullYear()}</div>
